...
SECRET_KEY = 'django-insecure-2%u-wa^ddnjm-mtd@k5$q1z9i=0@lds0s#em6$lo0qc9(q7z&4'
...
ROOT_URLCONF = 'edurider_backend.urls'
...
WSGI_APPLICATION = 'edurider_backend.wsgi.application'
